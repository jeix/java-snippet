...
import modern.java21.lang.void_.until_not_void.UntilNotVoid;
import static modern.java21.lang.void_.until_not_void.UntilNotVoid.unv;
import static modern.java21.lang.void_.until_not_void.UntilNotVoid.firstNonVoid;
...
public class UntilNotVoidDemo {
    ...
    public static void main(String[] args) {
        ...
        // Modern: Generic method for any type
        Object o = null;
        o = firstNonVoid(obj -> obj != null, (Object) null, new Something("foo"), new Something("bar"));
        expect("foo", o.toString());
        o = firstNonVoid(obj -> obj != null, new Something("foo"), new Something("bar"));
        expect("foo", o.toString());
        o = firstNonVoid(obj -> obj != null, (Object) null, new Something("foo"));
        expect("foo", o.toString());
        System.out.println("--------------------");
    }
}